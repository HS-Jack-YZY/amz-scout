...
| 6 | **Deployment** | Dockerfile (`python:3.12-slim-bookworm` + `uv tool install browser-use`), `docker-compose.yml`, AWS Lightsail provisioning, EBS volume mount, HTTPS certificate, domain configuration, smoke test | in-progress | - | 1 | [phase6-deployment.plan.md](../plans/phase6-deployment.plan.md) |
