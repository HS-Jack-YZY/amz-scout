...
| 6 | **Deployment** | Dockerfile (`python:3.12-slim-bookworm` + `uv tool install browser-use`), `docker-compose.yml`, AWS Lightsail provisioning, EBS volume mount, HTTPS certificate, domain configuration, smoke test | pending | - | 1 | - |
